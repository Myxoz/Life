...
import com.myxoz.life.storage.interfaces.utils.RangedPerformantCache
    ...
    private val _cachedSummaries = RangedPerformantCache<LocalDate, Cached<FullDaySyncable>>(
        ...
        },
        {
            LocalDate.ofEpochDay(
                it.value?.id ?: error("Database returned null (but not null) in DaySummaryRepo")
            )
        },
    )
